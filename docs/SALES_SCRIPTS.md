...
🎨 Свой брендбук клуба — 5 000 ₽ один раз (по желанию)
```

**Имена:**
- *Prime Mafia* — бренд (ваш клуб, карты, сообщество)
- *Maf Assist by Prime Mafia* — продукт для продажи другим клубам

**В боте у собственника:** «💳 Тариф и пакет» — статус теста/пакета, кнопки Mini / Start / Club → заявка вам в Telegram.
...
## 5. Upsell стилизации (свой брендбук)

```
Стиль и карты Prime Mafia в приложении — бесплатно, они уже красивые.

Платно только если клуб хочет свой бренд:
— загрузить свои карты ролей;
— цвета и тему интерфейса под клуб;
— игроки видят «ваш» стол.

Стоимость своей стилизации: 5 000 ₽ один раз.
...
— готовые красивые карты Prime Mafia уже в боте — бесплатно;
— начать проводить игры можно сегодня — тест 2 игры бесплатно;
— если нужны ваши карты и цвета (брендбук) — 5 000 ₽ один раз.

То есть на старте не ждёте печать и не платите 10к «на входе».
```
...
🃏 Бумажные карты ≈ 10 000 ₽ (дизайн + ламинация + печать)

📱 Maf Assist by Prime Mafia
— карты Prime Mafia уже в боте — бесплатно, играть можно сегодня;
— ваши макеты/брендбук — 5 000 ₽ один раз, когда будете готовы.
