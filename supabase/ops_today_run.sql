-- =============================================================================
-- TODAY OPS: run this whole file once in Supabase SQL Editor
-- 1) perf indexes + rating RPC (fixes missing sportivniy)
-- 2) durable broadcast jobs table
-- 3) verification queries (look at Results)
-- =============================================================================

-- --- A. Column + indexes + RPC ------------------------------------------------
