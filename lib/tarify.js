...
/** Экономия vs бумажные карты: дизайн + ламинация + печать ≈ 10 000 ₽ */
function tekstEkonomiyaKart() {
    return 'Отдельный счёт, который часто забывают:\n\n' +
        ...
        '— стилизация под клуб — *' + formatRub(STILIZATSIYA_PRICE) + ' ₽ один раз* (не каждый тираж);\n' +
...
function tekstUpsellStilizasii() {
    return 'После тарифа многие клубы берут стилизацию за *' + formatRub(STILIZATSIYA_PRICE) + ' ₽* — один раз, навсегда.\n\n' +
        'Что даёт:\n' +
