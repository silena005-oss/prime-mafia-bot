...
/** In-process queue: one broadcast at a time, callback returns immediately. */
...
/** Queue broadcast; resolves when this job finishes (does not block other handlers if fire-and-forget). */
...
async function razoslatAnons(bot, klub_id, klub, anons, botUsername, exclude_tg_id) {
    return postavitRassylkuVOchered(async () => {
